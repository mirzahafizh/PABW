...
function handlePayment($username, $orders, $pdo) {
    ...
    if (deductBalance($username, $totalPriceToDeduct, $pdo)) {
        ...
        foreach ($orders as $order) {
            ...
            $stmt->execute([$username, $productName, 'menunggu kurir', $phone, $address, $storeAddress, $storeName, $shippingCost, $totalPrice, $price * $quantity, $sellerName, $photo, $quantity]);
        }
                    ...
                    <?php foreach ($orders as $order) : ?>
                        <div class="border-b border-gray-300 py-4 flex flex-wrap items-center">
                            ...
                            <div>
                                ...
                                <div class="w-full  px-4 mb-2 lg:mb-0">
                                    <p class="text-lg font-bold"><?php echo $order['quantity']; ?></p>
                                </div>
                                <div class="w-full  px-4 mb-2 lg:mb-0">
