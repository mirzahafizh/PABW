...
<div>
    ...
    <!-- Input pencarian -->
    <input type="text" id="searchInput" onkeyup="searchUsers()" placeholder="Cari nama pengguna..." class="border p-2 mb-4">
    
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php foreach ($users as $user): ?>
        <div class="border p-4 user-item">
            ...
            <form method="post" action="admin.php" class="inline-block">
                ...
                <button type="submit" name="delete_user" class="bg-red-500 text-white py-2 px-4 mt-2 mr-2">Delete User</button>
            </form>
    
            <a href="admin.php?action=edit_user&username=<?php echo $user['username']; ?>" class="bg-blue-500 text-white py-2 px-4 mt-2 inline-block">Edit User</a>
        </div>
        <?php endforeach; ?>
    </div>
</div>
